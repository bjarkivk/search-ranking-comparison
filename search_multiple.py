...
RESULTS_FILE = 'comparison_seed108_200.csv'                 # Name of the file where the results will appear in
RANK_P = 10                                                 # How many search results we evaluate, set to 10 because the re-ranker only re-ranks first 10 hits
random.seed(108)                                            # Random seed for sampling of the queries, can be commented out
